    ...
    <footer>
      <div className="container footer-1">
        ...
        <section className="footer-adress">
          ...
          <div>
            <p>
              4 chemin des bruyères 37270 ATHEE SUR CHER Indre et Loire France
            </p>
            <ul>
              <li>
                <p>
                  Téléphone: <span>+33629755521</span>
                </p>
              </li>
              <li>
                <p>
                  Mobile: <span>+33664811175</span>
                </p>
              </li>
              <li>
                <p>
                  Email: <span>contact@inbed.fr</span>
                </p>
              </li>
            </ul>
          </div>
